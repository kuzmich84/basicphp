...
<body>
  <h2>Guitar Wars - санкционирование </h2>
...
<?php
  ...
  if (isset($_POST['submit'])) {
    if ($_POST['confirm'] == 'Yes') {
      ...
      echo '<p>Рейтинг ' . $score . ' для' . $name . 'был успешно санкционирован.';
    }
    else {
      echo '<p class="error">Возникла ошибка в санкционировании рейтинга.</p>';
    }
  }
